...
const needsAttentionItems = [
  ...
  },
  {
    ...
    title: 'Q1 Budget Approval Blocked - Needs Your Sign-off',
    summary: 'Task blocked: Marketing budget approval ($280K). Assigned by: Finance Lead. Due: Today 5 PM.',
    source: 'asana',
    sender: 'Finance Project',
...
const kudosItems = [
  ...
  },
  {
    ...
    summary: 'Rahul: "Amazing work team! We hit 112% of Q4 target. Celebrating tonight!" 🎊',
    source: 'whatsapp',
    sender: 'Rahul (CEO)',
...
const fyiItems = [
  {
    ...
    summary: 'Vikram (CEO, TechFlow): "Loved the demo. Can we discuss enterprise pricing for 50 seats?"',
    source: 'whatsapp',
    sender: 'Vikram (TechFlow)',
    timestamp: new Date(Date.now() - 2 * 60 * 60000).toISOString(),
    url: '#',
  },
  {
  ...
  },
  {
    ...
    summary: 'Task created: Review new dashboard mockups with UX team. Scheduled for Monday 2 PM.',
    source: 'asana',
    sender: 'Design Sprint',
